<div class="px-5 my-4">
    <div class="bg-white p-3 shadow-sm">
        <span class="h2">Update Emergency Service</span>
        <div class="my-3">
            <form wire:submit.prevent="save">
                <div>
                    <span class="form-label">Image:</span>
                    <label for="image" class="pointer image-upload d-flex justify-content-center align-items-center border hover-image-upload">
                        @if($new_image)
                    ...
                    <input id="image" class="d-none" type="file" accept="image/*" wire:model="new_image">
                    @if($errors->has('image'))
                        <div>
                ...
                <div class="my-3 col-6">
                    <button type="submit" class="btn btn-primary col-12">Update Service</button>
                </div>
            </form>
        </div>
    </div>
