<div class="col-12 h-100">
    ...
    <div class="d-md-flex text-center justify-content-between align-items-center col-12">
        <span class="h3 text-light">Welcome to Car Repair Seller Center! Please login.</span>
        <span class="text-light">Not a seller? <a href="{{ route('seller.register') }}" class="blue-link">Register here</a></span>
    </div>
        ...
        <form class="auth-form" wire:submit.prevent="login">
            ...
            <div class="my-5">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{ route('seller.reset_password') }}" class="blue-link">Forgot Password?</a>
                </div>
                <div class="mt-2 border">
