<div class="col-12 h-100">
    ...
    <div class="d-md-flex text-center justify-content-between align-items-center col-12">
        <span class="h3">Welcome to Car Repair Seller Center! Please login.</span>
        <span>Not a seller? <a href="{{ route('seller.register') }}" class="blue-link">Register here</a></span>
    </div>
